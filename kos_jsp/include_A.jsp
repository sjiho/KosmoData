...
<h3  style="background-color: orange;">INCLUDE_A JSP</h3>
<h>
<hr>
...
<%
	...
	out.println("include_A mid >>> : " + mid + "<br>");
	out.println("include_A mpw  >>> : " + mpw + "<br>");
	
	System.out.println("include_A mid >>> : " + mid);
	System.out.println("include_A mpw  >>> : " + mpw);
